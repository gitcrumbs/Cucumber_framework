...
@CucumberOptions(
        plugin = {"json:target/positive/cucumber.json", "pretty", "html:target/positive/cucumber.html","com.cucumber.listener.ExtentCucumberFormatter","rerun:src/test/java/failedTests/failed_scenarios.txt"},
        features =  {"src/test/resources/FeatureFiles"}, 
        glue = "steps",
        tags = {"@Banker-Transactions"}        
        )
